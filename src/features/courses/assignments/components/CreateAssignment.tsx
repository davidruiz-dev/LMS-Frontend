...
export default function CreateAssignment({ courseId, open, onOpenChange }: Props) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-2xl h-auto max-h-175 overflow-y-auto">
                <DialogHeader>
                        ...
                        <div className="space-y-1">
                            <Item variant={'outline'}>
                                ...
                                <ItemContent>
                                    ...
                                    <ItemDescription>Los alumnos podrán entregar esta tarea despues de la fecha de entrega.</ItemDescription>
                                </ItemContent>
                                <ItemContent>
                                    <FormField
                                        control={form.control}
