...
import { enrollmentSchema, type EnrollmentFormData } from '@/features/courses/enrollments/schemas/enrollment.schema'
        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>Selecciona un usuario para inscribir al curso.</DialogDescription>
                </DialogHeader>
                <Form {...form}>
                    <form className='space-y-4' onSubmit={form.handleSubmit(onSubmit)}>
                        ...
                        <Button disabled={!form.formState.isValid || createEnrollment.isPending}>
                            {createEnrollment.isPending ? 'Inscribiendo...' : 'Inscribir'}
                        </Button>
                    </form>
                </Form>
            </DialogContent>
